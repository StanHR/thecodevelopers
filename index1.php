                ...
                <?php
                    if(!isset($_SESSION['rn']))
                    {
                        print("<div class='login'>
                            <form id='login_form' method='POST' action='login_validation'>
                                <h2>Login</h2>
            ...
            <div class="col-md-6" style="clear:both">
                <div class="ideas">
                    <p id="gotideas">Got any cool ideas?</p>
                     <div>
                        <a href="project_request"><button class="button" id='fancy_submit'><span>Submit Idea</span></button></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div id='announcement_panel'>
                        <?php 
                            ...
                            //     echo("<a id='announcement_links' href='announcement_details?title=$title' style='text-decoration:none;'>
                            //                 <div class='row' id='announce_row'>
                            //                 <div class='col-5' style='text-align:center'>&nbsp;$date</div>
                            //                 <div class='col-7'><b>$title</b></div>
                            //                 </div></a>");
                            // }
                        ?> 
